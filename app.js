  ...
  jacket: {
    ...
    risks: [
      ...
      { category:'虚假宣传争议', dim:'打假', kw:'全压胶', level:'高危', lc:'r',
        ...
        evidence:'同类品牌曾因"全压胶"措辞被博主实测质疑，引发舆论争议。当前措辞存在同样风险。',
      ...
      { category:'技术悖论', dim:'打假', kw:'无氟涂层', level:'中危', lc:'o',
        ...
        evidence:'纺织专家分析：无氟拒水剂理论上无法达到4级拒油。若被质疑需提供拒油测试报告。',
      ...
      { category:'认知鸿沟', dim:'认知', kw:'全压胶', level:'低危', lc:'g',
        ...
        evidence:'行业数据显示"全压胶"是消费者理解偏差最高频的争议点，易引发差评和退货。',
    ...
    complaints: [
      { q:'你们详情页写的所有裁片接缝处均压胶，为什么口袋没有压胶？是不是虚假宣传？', tags:['全压胶','口袋'],
        ...
        ctx:['售前扫描标注"全压胶"为虚假宣传争议（高危）','行业案例：类似品牌因压胶措辞引发舆论风险','国标 GB/T 32624-2023 定义"全压胶"为主要防水接缝处','高频争议点，建议上架前修改措辞'] },
      { q:'你们说无氟，但博主检测出来有PFOA，是不是虚假宣传？', tags:['无氟','PFOA'],
        ...
        ctx:['售前扫描标注"无氟涂层"为技术悖论（中危）','无氟与拒油等级存在技术矛盾','建议上架前准备第三方拒油测试报告备查'] }
    ]
  },
  tshirt: {
  ...
  base: {
    ...
    risks: [
      { category:'医疗暗示', dim:'合规', kw:'不易长痘', level:'高危', lc:'r',
        ...
        evidence:'违反《广告法》第十七条关于医疗功效宣传的规定，被举报后罚款可达20万以上。',
      ...
      { category:'证据支撑不足', dim:'打假', kw:'7A 抗菌', level:'高危', lc:'r',
        ...
        evidence:'《广告法》及电商平台规范要求：凡提及功能性宣称，必须在详情页展示第三方检测报告。缺失报告在监管抽检中将被判定"证据支撑不足"。',
    ...
    complaints: [
      { q:'你们说"不易长痘"，这是医疗功效宣传吧？我要投诉虚假宣传。', tags:['长痘','医疗暗示'],
        steps:[
          ...
          {t:'整改措施',x:'我们会立即修改详情页，将该表述改为"保持肌肤清爽环境"。感谢您的反馈。'},
          {t:'订单处理',x:'支持7天无理由退货，并承担运费。'},
          {t:'致谢',x:'再次感谢您的宝贵意见，帮助我们改进产品描述。'}],
        ctx:['售前扫描标注"不易长痘"为医疗暗示（高危）','违反《广告法》第十七条','建议上架前将该表述改为"保持肌肤清爽环境"'] },
      { q:'你们说7A抗菌，检测报告在哪里？我怎么知道是真的？', tags:['7A抗菌','检测报告'],
        ...
        ctx:['售前扫描标注"7A抗菌"为证据支撑不足（高危）','平台要求功能宣称需附检测报告','建议在详情页每项功能后增加报告链接'] },
      { q:'你们这个尺码也太大了吧！我平时穿L，这次买L像睡衣一样，要退货换M。', tags:['尺码','偏大'],
        ...
        ctx:['售前扫描标注"宽松版型"为认知鸿沟（低危）','同类商品退换货率最高原因','建议在主图增加"拍小1-2码"醒目提示'] }
    ]
  }
};
...
const KNOWLEDGE_BASE = {
  jacket: [
    ...
    { id:'j_case_1', type:'case',
      title:'行业案例：冲锋衣"全压胶"措辞引发的舆论风险',
      summary:'同类品牌因"全压胶"表述被质疑，引发大规模舆论讨论',
      detail:'行业参考案例：某冲锋衣品牌因详情页"全压胶"措辞，被测评博主拆解后指出口袋无压胶，质疑虚假宣传，视频播放量超 500 万。\n行业专家回应"口袋不压胶是通行做法"，但消费者已形成认知偏差。\n启示：如当前文案保持"全压胶"表述，存在被同样方式质疑的高概率风险。',
      source:'行业公开案例 · 2024',
      relatedRisks:['全压胶'], tags:['打假','舆情'] },
    { id:'j_int_1', type:'internal',
      title:'公司送检报告：PFOA/PFOS 检测结果',
      summary:'大货成衣 PFOA 未检出，符合国标"无氟整理"认定',
      detail:'送检结果：PFOA 0.90μg/㎡，低于国标 1.0μg/㎡ 上限，判定合格。大货成衣复检：PFOA 和 PFOS 均为"未检出"，远低于国标限值。\n检测机构：SGS · 报告编号 SHTS-2024-XXXXX。\n建议：留存报告，若被质疑时可第一时间出示。',
      source:'SGS 检测报告 · 公司品控部',
      relatedRisks:['无氟涂层'], tags:['打假','检测'] },
    { id:'j_exp_1', type:'expert',
      title:'专家分析：无氟与拒油等级的技术矛盾',
      summary:'"无氟拒水剂理论上无法达到 4 级拒油，需关注表述准确性"',
      detail:'纺织材料专家分析：C0（无氟）拒水剂的分子结构决定其仅能实现拒水功能，无法达到 ISO 14419 标准 4 级拒油。\n建议：若保留"拒油"宣称，应提前准备第三方拒油测试报告；否则应删除"拒油等级 4 级"的表述，仅保留"防水"功能宣称。',
      source:'纺织材料工程专家 · 行业分析',
  ...
  base: [
    ...
    { id:'b_case_1', type:'case',
      title:'行业案例：功能宣称缺报告被处罚',
      summary:'某品牌因"抗菌防螨"宣称缺报告被罚 15 万元',
      detail:'2024 年，某内衣品牌因详情页宣称"AAA 级抗菌""防螨率 99%"但未在页面展示检测报告，被市场监管局处罚 15 万元。\n关键教训：品牌事后提交了报告，但因"发布广告时未同步展示"仍被判违规。\n启示：有报告不够，必须在上架时同步展示。当前打底衫详情页存在同样风险。',
      source:'市场监管局行政处罚公开案例 · 2024',
